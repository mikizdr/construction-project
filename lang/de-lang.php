...
$title = 'Construction Project - Beratung & Verkauf - Entwerfen - Konstruieren - Gebäude';

$language = ['English', 'Български', 'Deutsch', 'Српски'];

$slogan = 'Beratung & Verkauf - Entwerfen - Konstruieren - Gebäude';

$menu = ['zuhause', 'Über uns', 'dienstleistungen', 'portfolio', 'kontakt'];

$slides = [
    ['Willkommen Im ', 'Construction project ltd.'],
    ['Schauen Sie ', 'Wer Wir Sind'],
    ['Schauen Sie ', 'Was Wir Tun'],
    ['Schauen Sie ', 'Unsere Referenzliste'],
    ['Kontaktiere ', 'Uns']
];
